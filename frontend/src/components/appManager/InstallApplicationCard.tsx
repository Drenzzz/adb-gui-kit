...
export function InstallApplicationCard({
  apkPath,
  isInstalling,
  onSelectApk,
  onInstall,
  ...
  return (
    <Card className="border border-border/60 bg-card/90 backdrop-blur shadow-xl">
      <CardHeader>
        ...
        <CardDescription>
          Use the picker below to sideload an APK onto the connected device.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-5">
        ...
        <p className="text-xs text-muted-foreground">
          Make sure the device allows installs from unknown sources over USB or wireless debugging.
        </p>
      </CardContent>
    </Card>
  );
