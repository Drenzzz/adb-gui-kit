...
export function BatchUninstallPackages(arg1:Array<string>):Promise<Array<backend.UninstallResult>>;

export function CopyPaths(arg1:Array<string>,arg2:string):Promise<Array<backend.FileOperationResult>>;

export function DeletePaths(arg1:Array<string>):Promise<Array<backend.FileOperationResult>>;
...
export function GetPackageDetail(arg1:string):Promise<backend.PackageDetail>;
...
export function ListInstalledPackages(arg1:boolean):Promise<Array<backend.PackageInfo>>;

export function MovePaths(arg1:Array<string>,arg2:string):Promise<Array<backend.FileOperationResult>>;
...
export function RenamePath(arg1:string,arg2:string):Promise<backend.FileOperationResult>;
...
export function UpdatePackageLabels(arg1:Array<string>):Promise<Array<backend.PackageInfo>>;
