...
export function BatchUninstallPackages(arg1) {
  return window['go']['backend']['App']['BatchUninstallPackages'](arg1);
}

export function CopyPaths(arg1, arg2) {
  return window['go']['backend']['App']['CopyPaths'](arg1, arg2);
}

export function DeletePaths(arg1) {
  return window['go']['backend']['App']['DeletePaths'](arg1);
}
...
export function GetPackageDetail(arg1) {
  return window['go']['backend']['App']['GetPackageDetail'](arg1);
}
...
export function ListInstalledPackages(arg1) {
  return window['go']['backend']['App']['ListInstalledPackages'](arg1);
}

export function MovePaths(arg1, arg2) {
...
export function UpdatePackageLabels(arg1) {
  return window['go']['backend']['App']['UpdatePackageLabels'](arg1);
}
